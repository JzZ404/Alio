...
This model is fine-tuned from **Gemma 4 E2B**, a model from the Gemma family
released by Google. Training data for the "caregiver shift compilation" task
was generated by **Gemma 4 31B** via Google's GenAI API
(teacher-student distillation).

**Gemma is a trademark of Google LLC.** This fine-tune is not endorsed by
or affiliated with Google.
