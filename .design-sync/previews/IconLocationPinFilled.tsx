import { IconLocationPinFilled } from '@alio/ui';

/**
 * IconLocationPinFilled — one of the icons the Alio screens use. Icons are plain SVG
...
export const Sizes = () => (
  <Row>
    <IconLocationPinFilled width={16} height={16} />
    <IconLocationPinFilled width={24} height={24} />
    <IconLocationPinFilled width={32} height={32} />
  </Row>
);
...
export const Colors = () => (
  <Row>
    <span style={{ color: 'var(--color-gray-100)', display: 'inline-flex' }}>
      <IconLocationPinFilled width={28} height={28} />
    </span>
