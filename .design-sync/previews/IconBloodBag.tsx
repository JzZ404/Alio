import { IconBloodBag } from '@alio/ui';

/**
 * IconBloodBag — one of the icons the Alio screens use. Icons are plain SVG
...
export const Sizes = () => (
  <Row>
    <IconBloodBag width={16} height={16} />
    <IconBloodBag width={24} height={24} />
    <IconBloodBag width={32} height={32} />
  </Row>
);
...
export const Colors = () => (
  <Row>
    <span style={{ color: 'var(--color-gray-100)', display: 'inline-flex' }}>
      <IconBloodBag width={28} height={28} />
    </span>
