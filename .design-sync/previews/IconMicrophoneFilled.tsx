import { IconMicrophoneFilled } from '@alio/ui';

/**
 * IconMicrophoneFilled — one of the icons the Alio screens use. Icons are plain SVG
...
export const Sizes = () => (
  <Row>
    <IconMicrophoneFilled width={16} height={16} />
    <IconMicrophoneFilled width={24} height={24} />
    <IconMicrophoneFilled width={32} height={32} />
  </Row>
);
...
export const Colors = () => (
  <Row>
    <span style={{ color: 'var(--color-gray-100)', display: 'inline-flex' }}>
      <IconMicrophoneFilled width={28} height={28} />
    </span>
