import { IconMedicalPrescription } from '@alio/ui';

/**
 * IconMedicalPrescription — one of the icons the Alio screens use. Icons are plain SVG
...
export const Sizes = () => (
  <Row>
    <IconMedicalPrescription width={16} height={16} />
    <IconMedicalPrescription width={24} height={24} />
    <IconMedicalPrescription width={32} height={32} />
  </Row>
);
...
export const Colors = () => (
  <Row>
    <span style={{ color: 'var(--color-gray-100)', display: 'inline-flex' }}>
      <IconMedicalPrescription width={28} height={28} />
    </span>
