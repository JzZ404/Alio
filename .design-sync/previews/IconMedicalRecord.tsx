import { IconMedicalRecord } from '@alio/ui';

/**
 * IconMedicalRecord — one of the icons the Alio screens use. Icons are plain SVG
...
export const Sizes = () => (
  <Row>
    <IconMedicalRecord width={16} height={16} />
    <IconMedicalRecord width={24} height={24} />
    <IconMedicalRecord width={32} height={32} />
  </Row>
);
...
export const Colors = () => (
  <Row>
    <span style={{ color: 'var(--color-gray-100)', display: 'inline-flex' }}>
      <IconMedicalRecord width={28} height={28} />
    </span>
