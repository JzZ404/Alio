import { IconArrowUp } from '@alio/ui';

/**
 * IconArrowUp — one of the icons the Alio screens use. Icons are plain SVG
...
export const Sizes = () => (
  <Row>
    ...
    <IconArrowUp width={32} height={32} />
  </Row>
);
...
export const Colors = () => (
  <Row>
    <span style={{ color: 'var(--color-gray-100)', display: 'inline-flex' }}>
      <IconArrowUp width={28} height={28} />
    </span>
