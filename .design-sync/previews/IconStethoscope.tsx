import { IconStethoscope } from '@alio/ui';

/**
 * IconStethoscope — one of the icons the Alio screens use. Icons are plain SVG
...
export const Sizes = () => (
  <Row>
    ...
    <IconStethoscope width={24} height={24} />
    <IconStethoscope width={32} height={32} />
  </Row>
);
...
export const Colors = () => (
  <Row>
    <span style={{ color: 'var(--color-gray-100)', display: 'inline-flex' }}>
      <IconStethoscope width={28} height={28} />
    </span>
