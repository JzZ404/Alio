import { IconHeartRate } from '@alio/ui';

/**
 * IconHeartRate — one of the icons the Alio screens use. Icons are plain SVG
...
export const Sizes = () => (
  <Row>
    <IconHeartRate width={16} height={16} />
    <IconHeartRate width={24} height={24} />
    <IconHeartRate width={32} height={32} />
  </Row>
);
...
export const Colors = () => (
  <Row>
    <span style={{ color: 'var(--color-gray-100)', display: 'inline-flex' }}>
      <IconHeartRate width={28} height={28} />
    </span>
