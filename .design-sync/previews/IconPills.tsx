import { IconPills } from '@alio/ui';

/**
 * IconPills — one of the icons the Alio screens use. Icons are plain SVG
...
export const Sizes = () => (
  <Row>
    <IconPills width={16} height={16} />
    <IconPills width={24} height={24} />
    <IconPills width={32} height={32} />
  </Row>
);
