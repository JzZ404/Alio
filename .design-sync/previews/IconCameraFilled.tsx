import { IconCameraFilled } from '@alio/ui';

/**
 * IconCameraFilled — one of the icons the Alio screens use. Icons are plain SVG
...
export const Sizes = () => (
  <Row>
    <IconCameraFilled width={16} height={16} />
    <IconCameraFilled width={24} height={24} />
    <IconCameraFilled width={32} height={32} />
  </Row>
);
...
export const Colors = () => (
  <Row>
    <span style={{ color: 'var(--color-gray-100)', display: 'inline-flex' }}>
      <IconCameraFilled width={28} height={28} />
    </span>
