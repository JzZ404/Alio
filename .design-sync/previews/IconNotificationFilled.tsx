import { IconNotificationFilled } from '@alio/ui';

/**
 * IconNotificationFilled — one of the icons the Alio screens use. Icons are plain SVG
...
export const Sizes = () => (
  <Row>
    <IconNotificationFilled width={16} height={16} />
    <IconNotificationFilled width={24} height={24} />
    <IconNotificationFilled width={32} height={32} />
  </Row>
);
...
export const Colors = () => (
  <Row>
    <span style={{ color: 'var(--color-gray-100)', display: 'inline-flex' }}>
      <IconNotificationFilled width={28} height={28} />
    </span>
