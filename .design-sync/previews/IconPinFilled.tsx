import { IconPinFilled } from '@alio/ui';

/**
 * IconPinFilled — one of the icons the Alio screens use. Icons are plain SVG
...
export const Sizes = () => (
  <Row>
    ...
    <IconPinFilled width={24} height={24} />
    <IconPinFilled width={32} height={32} />
  </Row>
);
...
export const Colors = () => (
  <Row>
    <span style={{ color: 'var(--color-gray-100)', display: 'inline-flex' }}>
      <IconPinFilled width={28} height={28} />
    </span>
