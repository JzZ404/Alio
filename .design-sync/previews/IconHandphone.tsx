import { IconHandphone } from '@alio/ui';

/**
 * IconHandphone — one of the icons the Alio screens use. Icons are plain SVG
...
export const Sizes = () => (
  <Row>
    <IconHandphone width={16} height={16} />
    <IconHandphone width={24} height={24} />
    <IconHandphone width={32} height={32} />
  </Row>
);
...
export const Colors = () => (
  <Row>
    <span style={{ color: 'var(--color-gray-100)', display: 'inline-flex' }}>
      <IconHandphone width={28} height={28} />
    </span>
