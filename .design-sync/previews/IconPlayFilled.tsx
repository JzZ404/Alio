import { IconPlayFilled } from '@alio/ui';

/**
 * IconPlayFilled — one of the icons the Alio screens use. Icons are plain SVG
...
export const Sizes = () => (
  <Row>
    <IconPlayFilled width={16} height={16} />
    <IconPlayFilled width={24} height={24} />
    <IconPlayFilled width={32} height={32} />
  </Row>
);
...
export const Colors = () => (
  <Row>
    <span style={{ color: 'var(--color-gray-100)', display: 'inline-flex' }}>
      <IconPlayFilled width={28} height={28} />
    </span>
