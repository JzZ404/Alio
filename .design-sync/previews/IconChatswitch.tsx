import { IconChatswitch } from '@alio/ui';

/**
 * IconChatswitch — one of the icons the Alio screens use. Icons are plain SVG
...
export const Sizes = () => (
  <Row>
    <IconChatswitch width={16} height={16} />
    <IconChatswitch width={24} height={24} />
    <IconChatswitch width={32} height={32} />
  </Row>
);
...
export const Colors = () => (
  <Row>
    <span style={{ color: 'var(--color-gray-100)', display: 'inline-flex' }}>
      <IconChatswitch width={28} height={28} />
    </span>
