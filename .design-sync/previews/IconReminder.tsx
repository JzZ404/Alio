import { IconReminder } from '@alio/ui';

/**
 * IconReminder — one of the icons the Alio screens use. Icons are plain SVG
...
export const Sizes = () => (
  <Row>
    <IconReminder width={16} height={16} />
    <IconReminder width={24} height={24} />
    <IconReminder width={32} height={32} />
  </Row>
);
...
export const Colors = () => (
  <Row>
    <span style={{ color: 'var(--color-gray-100)', display: 'inline-flex' }}>
      <IconReminder width={28} height={28} />
    </span>
