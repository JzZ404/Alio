import { IconRiVoiceAiFill } from '@alio/ui';

/**
 * IconRiVoiceAiFill — one of the icons the Alio screens use. Icons are plain SVG
...
export const Sizes = () => (
  <Row>
    <IconRiVoiceAiFill width={16} height={16} />
    <IconRiVoiceAiFill width={24} height={24} />
    <IconRiVoiceAiFill width={32} height={32} />
  </Row>
);
...
export const Colors = () => (
  <Row>
    <span style={{ color: 'var(--color-gray-100)', display: 'inline-flex' }}>
      <IconRiVoiceAiFill width={28} height={28} />
    </span>
