...
export function SuggestionCard({
  ...
  return (
    <div className="flex flex-col self-end">
      <div className="mt-[8px] w-full max-w-[75%] self-end rounded-[18px] bg-gray-30/60 px-[16px] py-[14px]">
        ...
        <div className="mt-[14px] flex gap-[10px]">
          <button
            type="button"
            onClick={onMark}
            className="flex-1 rounded-[12px] bg-brand-accent px-[16px] py-[11px] text-[15px] font-bold text-brand-primary"
          >
            Mark it
          </button>
          <button
            type="button"
            onClick={onDismiss}
            className="flex-1 rounded-[12px] bg-white px-[16px] py-[11px] text-[15px] font-bold text-gray-100"
          >
            No need
          </button>
        </div>
